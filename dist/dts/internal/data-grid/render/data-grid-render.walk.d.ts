...
export declare function getBothSpanBounds(rowSpan: Item, colSpan: Item, cellX: number, cellY: number, cellW: number, row: number, getRowHeight: (row: number) => number, column: MappedGridColumn, allColumns: readonly MappedGridColumn[]): Rectangle | undefined;
export declare function getRowSpanBounds(rowSpan: Item, cellX: number, cellY: number, cellW: number, row: number, getRowHeight: (row: number) => number): Rectangle | undefined;
